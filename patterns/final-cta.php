...
$headline    = esc_html( $section['headline'] ?? 'Let\'s Work Together' );
$description = esc_html( $section['description'] ?? 'Take the first step today.' );
$cta_text    = esc_html( $section['cta_text'] ?? 'Get Started' );
?>
...
<section class="wp-block-group has-primary-background-color has-text-light-color has-background has-text-color">
  ...
  <div class="wp-block-group">
    ...
    <p class="has-text-align-center has-lg-font-size" style="color:rgba(255,255,255,0.7)"><?php echo $description; ?></p>
    <!-- /wp:paragraph -->
