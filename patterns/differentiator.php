...
<section class="wp-block-group has-primary-background-color has-text-light-color has-background has-text-color">
  ...
  <div class="wp-block-columns are-vertically-aligned-center">
    ...
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
      ...
      <p class="has-text-color has-sm-font-size" style="color:var(--wp--preset--color--cta);font-weight:600;letter-spacing:0.08em;text-transform:uppercase">Why Choose Us</p>
      <!-- /wp:paragraph -->
