 ...
 * Description: Two-column hero with image on the left, headline and CTA on the right.
 * Viewport Width: 1440
 */
?>
...
<div class="wp-block-group alignfull envosta-hero" style="padding-top:8rem;padding-right:2rem;padding-bottom:5rem;padding-left:2rem">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center envosta-reveal" style="flex-basis:50%">
			...
			<p class="has-muted-color has-text-color" style="font-size:1.1rem;line-height:1.6"><?php esc_html_e( 'A supporting paragraph that explains what you do and who you do it for, in plain language.', 'envosta' ); ?></p>
			<!-- /wp:paragraph -->
