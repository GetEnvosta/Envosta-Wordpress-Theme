...
/**
 * Title: Upsells
 * Slug: envosta/hidden-upsells
 * Inserter: no
 */
declare( strict_types = 1 );
?>

<!-- wp:group {"metadata":{"name":"Upsells","patternName":"envosta/hidden-upsells"},"align":"wide","className":"is-style-default","style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
	...
	<div class="wp-block-woocommerce-product-collection">
		...
		<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--40)">
			...
			<div class="wp-block-group">
				<!-- wp:heading -->
				<h2 class="wp-block-heading"><?php esc_html_e('You might also like', 'envosta');?></h2>
				<!-- /wp:heading -->
